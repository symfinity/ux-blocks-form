...
namespace Symfinity\UxBlocksForm\Css;
 ...
 */
final class BlocksFormCssProvider
{
    ...
    {
        return 'ux-blocks-form/styles/blocks-form.css';
    }

    public function stylesheet(): string
    {
        $entry = $this->packageDir . '/assets/styles/blocks-form.css';
