 ...
 * packages/ux-blocks-form/vendor — that fatals on Psr\Container redeclare.
 */
...
if ($isMonorepo && is_file($packageAutoload) && $packageAutoloadActive) {
    fwrite(STDERR, <<<'TXT'
Unsafe test bootstrap: symfinity monorepo vendor AND packages/ux-blocks-form/vendor are both present,
...
Use instead:
  ...
  rm -rf packages/ux-blocks-form/vendor
